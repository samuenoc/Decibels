        ...
        <div className="space-y-12">
            ...
            <div className="text-center space-y-4">
                <h1 className="text-4xl font-bold text-balance">
                    <span className="text-cyber-pink">Sube</span> <span className="text-cyber-pink">Tu Música</span>
                </h1>
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
                    Comparte tu creatividad con el mundo. Sube tus pistas y comienza a ganar con cada reproducción a través
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <Card className="bg-card/30 border-electric-blue/20 text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground">Tu música se publica inmediatamente</p>
                </Card>
                ...
                <Card className="bg-card/30 border-neon-green/20 text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground">Llega a oyentes en todo el mundo al instante</p>
                </Card>
            </div>
                ...
                <CardContent className="space-y-4">
                    <div className="grid gap-4">
                        <div className="flex gap-3">
                            ...
                            <div>
                                <h4 className="font-semibold">Procesamiento de Archivos</h4>
                                <p className="text-sm text-muted-foreground">
                                    Tu archivo de audio se procesa y optimiza para streaming
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Tu música está disponible de inmediato para streaming</p>
                            </div>
                        </div>
                    </div>
                </CardContent>
